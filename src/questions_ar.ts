...
{ question: "ما هي أكثر مباراة شهدت أهدافًا؟", choices: ["أمريكا ساموا وأستراليا", "البرازيل والأرجنتين", "إسبانيا والبرتغال", "ألمانيا وإيطاليا"], answer: "أمريكا ساموا وأستراليا", category: "رياضة", difficulty: 'medium' },

{
  question: "من هو اللاعب الذي سجل أسرع هاتريك في تاريخ الدوري الإنجليزي الممتاز؟",
  choices: ["كريستيانو رونالدو", "روبي فاولر", "ساديو ماني", "ألان شيرر"],
  answer: "ساديو ماني",
  category: "رياضة",
  difficulty: "hard"
},
{
  question: "ما هو الفريق الذي فاز بالدوري الإنجليزي الممتاز دون أن يخسر أي مباراة؟",
  choices: ["تشيلسي", "مانشستر يونايتد", "ليفربول", "أرسنال"],
  answer: "أرسنال",
  category: "رياضة",
  difficulty: "hard"
},
{
  question: "من هو أصغر لاعب شارك في مباراة بالدوري الإنجليزي الممتاز؟",
  choices: ["ثيو والكوت", "إيثان نوانيري", "واين روني", "جود بيلينغهام"],
  answer: "إيثان نوانيري",
  category: "رياضة",
  difficulty: "hard"
},
{
  question: "أي فريق سجل أكبر عدد من النقاط في موسم واحد في تاريخ الدوري الإنجليزي الممتاز؟",
  choices: ["ليفربول", "مانشستر يونايتد", "مانشستر سيتي", "أرسنال"],
  answer: "مانشستر سيتي",
  category: "رياضة",
  difficulty: "hard"
},
{
  question: "من هو أول لاعب يسجل 5 أهداف في مباراة واحدة في الدوري الإنجليزي بعد عام 2000؟",
  choices: ["أغويرو", "بيركامب", "آندي كول", "دييميتار برباتوف"],
  answer: "دييميتار برباتوف",
  category: "رياضة",
  difficulty: "hard"
},
{
